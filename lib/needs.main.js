(function (root) {
			...
			if (!script.readyState || script.readyState === "complete" || script.readyState === "loaded") {
				...
				if (_defineQ.length) {
					...
					if (q) {
						...
						*/
						q.splice(0,0, m); // set the module id
	...
	*/
	var define = function (id, dependencies, factory, alreadyQed, depsLoaded, module, facArgs, context, ri, i, j, q, ready) {
